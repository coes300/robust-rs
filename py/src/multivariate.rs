...
/// :class:`MScatter`).
#[pyclass(name = "ScatterFit", module = "pyrobust", frozen)]
...
#[pyclass(name = "McdFit", module = "pyrobust", frozen)]
pub struct McdFit {
    inner: mv::McdFit,
}
...
/// χ²-calibrated).
#[pyclass(name = "TylerFit", module = "pyrobust", frozen)]
pub struct TylerFit {
    inner: mv::TylerFit,
}
...
#[pyclass(name = "Mcd", module = "pyrobust", frozen)]
pub struct Mcd {
    coverage: Option<f64>,
    n_subsamples: usize,
    reweight: bool,
...
/// defaults to ``Qn``.
#[pyclass(name = "Ogk", module = "pyrobust", frozen)]
pub struct Ogk {
    scale: AnyScale,
    n_iter: usize,
    reweight: bool,
...
/// Huber.
#[pyclass(name = "MScatter", module = "pyrobust", frozen)]
pub struct MScatter {
    loss: AnyLoss,
    control: Control,
}
...
/// median.
#[pyclass(name = "Tyler", module = "pyrobust", frozen)]
pub struct Tyler {
